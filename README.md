...
3. 在“照片库”中组合决定状态与 AI 分析筛选，或从“AI 建议、待决定、已保留、已移除”快捷入口进入对应结果；相似连拍继续按组整理。
...
输出位于 `dist\照片筛选器\`、`dist\照片筛选器-v1.3.0\`，并生成可上传到 GitHub Release 的 `dist\照片筛选器-v1.3.0-Windows-便携版.zip`。

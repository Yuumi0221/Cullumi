...
class WebStaticTests(unittest.TestCase):
    ...
    def test_home_uses_adaptive_golden_split_and_searchable_two_column_recents(self):
        ...
        self.assertIn("grid-template-columns:calc(100vw / 1.618 - clamp(28px, 4vw, 80px)) minmax(320px,1fr);", styles)
        self.assertIn("grid-template-columns:repeat(2,minmax(0,1fr));", styles)
        self.assertIn("padding:clamp(24px,4vh,56px) clamp(35px,4vw,80px);", styles)
        ...
        self.assertIn("background: #294f3a", styles)

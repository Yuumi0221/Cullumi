...
async function boot(){
  ...
  renderProfiles();$("#autoAdvance").checked=!!b.settings.auto_advance;$("#blinkDetectionEnabled").checked=b.settings.blink_detection_enabled!==false;$("#autoCheckUpdates").checked=!!b.settings.auto_check_updates;$("#motionCoverWriteback").value=b.settings.motion_cover_writeback||"ask";$("#defaultCache").value=b.settings.default_cache_root;
